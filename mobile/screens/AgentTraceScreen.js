/**
 * AgentTraceScreen.js — Reasoning-First Edition
 *
...
export default function AgentTraceScreen({ route, navigation }) {
  ...
  return (
    <View style={styles.container}>
      <ScreenHeader navigation={navigation} title="Agent Trace" />
      <ScrollView
      ...
      >
        ...
        {logs.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyStateText}>No agent logs available for this booking.</Text>
          </View>
        ) : logs.map((log, index) => {
            ...
            >
              ...
              {isExpanded && (
                <View style={styles.logDetails}>
                  {log.reasoning && (
                    <DetailBlock icon="💭" title="Agent Reasoning" color={meta.color} highlight>
